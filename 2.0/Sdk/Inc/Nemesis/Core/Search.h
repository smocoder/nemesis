...
namespace Nemesis
{
	...
	inline int Find_Linear( const T* a, int count, const U& v )
	{
	...
	inline int Find_Linear( const T& a, int count, const U& v, const Predicate& predicate )
	{
		for ( int i = 0; i < count; ++i )
		{
			if (predicate(a[i], v))
	...
	// This overload uses comparison operators for comparison.
	template <typename T, typename U>
	inline int Find_Binary( const T* a, int count, const U& v )
	{
		int pivot;
		int start = 0;
		int end = count-1;
	...
	template <typename T, typename U, typename Predicate>
	inline int Find_Binary( const T* a, int count, const U& v, const Predicate& predicate )
	{
		int cmp;
		int pivot;
		int start = 0;
